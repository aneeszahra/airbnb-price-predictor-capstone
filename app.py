...
if st.button(" Predict Price", type="primary", use_container_width=True):
    try:
        ...
        feature_names = ['latitude', 'longitude', 'minimum_nights', 'number_of_reviews', 
                        'reviews_per_month', 'calculated_host_listings_count', 
                        'availability_365', 'days_since_review', 'popularity_score', 
                        'is_superhost', 'neighbourhood_group_Brooklyn', 
...
st.markdown("---")
st.caption(" Built with Streamlit | Model: Gradient Boosting | Accuracy: R² = 0.68")